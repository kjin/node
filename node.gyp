  ...
  'targets': [
    ...
    }, # node_core_target_name
    {
      ...
      'sources': [
        ...
        'src/tcp_wrap.cc',
        'src/timers.cc',
        'src/tracing/legacy_agent.cc',
        'src/tracing/node_trace_buffer.cc',
        'src/tracing/node_trace_writer.cc',
        'src/tracing/perfetto/node_task_runner.cc',
        'src/tracing/perfetto/node_tracing.cc',
        'src/tracing/perfetto/file_writer_consumer.cc',
        'src/tracing/perfetto/tracing_controller_producer.cc',
        'src/tracing/node_producer_endpoint.cc',
        ...
        'src/tcp_wrap.h',
        'src/tracing/agent.h',
        'src/tracing/legacy_agent.h',
        'src/tracing/node_trace_buffer.h',
        'src/tracing/node_trace_writer.h',
        'src/tracing/perfetto/node_shared_memory.h',
        'src/tracing/perfetto/node_task_runner.h',
        'src/tracing/perfetto/node_tracing.h',
        'src/tracing/perfetto/file_writer_consumer.h',
        'src/tracing/perfetto/tracing_controller_producer.h',
        'src/tracing/node_producer_endpoint.h',
